...
def initialize_db():
    ...
    acc.createCourt("Margaret Hie Ding Lin Park Basketball Court", 5, 1, 0, 1, 0, 1, '11-19', '$4.00', 'Chinatown, Chicago', 'In a busy corner of Chinatown, this court has its problems, but it is probably the nicest looking court I have ever been to. The wood is easily scratched, but it is well maintained and not often crowded.')
    acc.createCourt("Gill Park Basketball Court", 3, 1, 0, 1, 0, 1, '10-19', '$7.00', 'Lakeview East, Chicago', 'Expensive and not often worth the cost. While it is out of the way and not often crowded, it is hard to justify the cost. Many teams practice here, and can get a discount, which can make it worth it in some cases.')
    ...
    acc.createCourt("Waneka Lake", 4.5, 0, 1, 1, 0, 1, 'Always', 'Free', 'Lafayette, CO', 'A lovely court next to Waneka lake. Well maintained and only a short walk from the play park. The lighting is not the best during the fall when it gets dark out, but during the summer it is the best spot.')
